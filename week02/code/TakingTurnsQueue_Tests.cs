...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue order was reversed because enqueue inserted at the front instead of the back. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players with 0 turns were not treated as infinite-turn players and were removed from the queue. 
    ...
    // Defect(s) Found: Players with negative turns were not treated as infinite-turn players and were removed from the queue. 
